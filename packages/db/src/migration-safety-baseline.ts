...
export const MIGRATION_SAFETY_BASELINE = [
  ...
  {
    id: "2ddc453e08ccfb09",
    rule: "loop-mutation-large-table",
    migration: "0126_issue_comment_derived_attribution.sql",
    table: "issue_comments",
    reason: "Historical issue-attribution backfill predates the migration-safety guard and is retained for lineage compatibility.",
  },
  {
    id: "00b604422aa6cd35",
    rule: "batched-mutation-large-table-missing-index",
    migration: "0126_issue_comment_derived_attribution.sql",
    table: "issue_comments",
    reason: "Historical issue-attribution backfill predates the migration-safety guard and is retained for lineage compatibility.",
  },
